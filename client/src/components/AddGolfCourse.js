...
function AddGolfCourse(props) {
    ...
    function onSubmit(e) {
        ...
        const newCourse = {
            ...
            holes: {
                1: { name: hole1name, yellowYds: hole1YellowYds, par: hole1par, SI: hole1SI },
                2: { name: hole2name, yellowYds: hole2YellowYds, par: hole2par, SI: hole2SI },
                3: { name: hole3name, yellowYds: hole3YellowYds, par: hole3par, SI: hole3SI },
                4: { name: hole4name, yellowYds: hole4YellowYds, par: hole4par, SI: hole4SI },
                5: { name: hole5name, yellowYds: hole5YellowYds, par: hole5par, SI: hole5SI },
                6: { name: hole6name, yellowYds: hole6YellowYds, par: hole6par, SI: hole6SI },
                7: { name: hole7name, yellowYds: hole7YellowYds, par: hole7par, SI: hole7SI },
                8: { name: hole8name, yellowYds: hole8YellowYds, par: hole8par, SI: hole8SI },
                9: { name: hole9name, yellowYds: hole9YellowYds, par: hole9par, SI: hole9SI },
                10: { name: hole10name, yellowYds: hole10YellowYds, par: hole10par, SI: hole10SI },
                11: { name: hole11name, yellowYds: hole11YellowYds, par: hole11par, SI: hole11SI },
                12: { name: hole12name, yellowYds: hole12YellowYds, par: hole12par, SI: hole12SI },
                13: { name: hole13name, yellowYds: hole13YellowYds, par: hole13par, SI: hole13SI },
                14: { name: hole14name, yellowYds: hole14YellowYds, par: hole14par, SI: hole14SI },
                15: { name: hole15name, yellowYds: hole15YellowYds, par: hole15par, SI: hole15SI },
                16: { name: hole16name, yellowYds: hole16YellowYds, par: hole16par, SI: hole16SI },
                17: { name: hole17name, yellowYds: hole17YellowYds, par: hole17par, SI: hole17SI },
                18: { name: hole18name, yellowYds: hole18YellowYds, par: hole18par, SI: hole18SI },
            }
        }
    ...
    let allNames = [hole1name, hole2name, hole3name, hole4name, hole5name, hole6name, hole7name, hole8name, hole9name, hole10name, hole11name, hole12name, hole13name, hole14name, hole15name, hole16name, hole17name, hole18name]

    let allSetNames = [setHole1name, setHole2name, setHole3name, setHole4name, setHole5name, setHole6name, setHole7name, setHole8name, setHole9name, setHole10name, setHole11name, setHole12name, setHole13name, setHole14name, setHole15name, setHole16name, setHole17name, setHole18name]

    let allYellowYds = [hole1YellowYds, hole2YellowYds, hole3YellowYds, hole4YellowYds, hole5YellowYds, hole6YellowYds, hole7YellowYds, hole8YellowYds, hole9YellowYds, hole10YellowYds, hole11YellowYds, hole12YellowYds, hole13YellowYds, hole14YellowYds, hole15YellowYds, hole16YellowYds, hole17YellowYds, hole18YellowYds]

    let allSetYellowYds = [setHole1YellowYds, setHole2YellowYds, setHole3YellowYds, setHole4YellowYds, setHole5YellowYds, setHole6YellowYds, setHole7YellowYds, setHole8YellowYds, setHole9YellowYds, setHole10YellowYds, setHole11YellowYds, setHole12YellowYds, setHole13YellowYds, setHole14YellowYds, setHole15YellowYds, setHole16YellowYds, setHole17YellowYds, setHole18YellowYds]

    let allPars = [hole1par, hole2par, hole3par, hole4par, hole5par, hole6par, hole7par, hole8par, hole9par, hole10par, hole11par, hole12par, hole13par, hole14par, hole15par, hole16par, hole17par, hole18par]

    let allSetPars = [setHole1par, setHole2par, setHole3par, setHole4par, setHole5par, setHole6par, setHole7par, setHole8par, setHole9par, setHole10par, setHole11par, setHole12par, setHole13par, setHole14par, setHole15par, setHole16par, setHole17par, setHole18par]

    let allSIs = [hole1SI, hole2SI, hole3SI, hole4SI, hole5SI, hole6SI, hole7SI, hole8SI, hole9SI, hole10SI, hole11SI, hole12SI, hole13SI, hole14SI, hole15SI, hole16SI, hole17SI, hole18SI]

    let allSetSIs = [setHole1SI, setHole2SI, setHole3SI, setHole4SI, setHole5SI, setHole6SI, setHole7SI, setHole8SI, setHole9SI, setHole10SI, setHole11SI, setHole12SI, setHole13SI, setHole14SI, setHole15SI, setHole16SI, setHole17SI, setHole18SI]
